...
Original file is located at
    https://colab.research.google.com/drive/1pNB98zhGowjjmh35eU_LObtpNwUBBYkK
"""
...
trainfile = r'/gdrive/My Drive/Python/Train - cmc.csv'
trainData = pd.read_csv(trainfile)

#Read test data file
testfile = r'/gdrive/My Drive/Python/Test - cmc.csv'
...
pd.concat([pred,pred_Probability],axis=1).to_csv("/gdrive/My Drive/Python/results.csv", index = None)

res=pd.read_csv('/gdrive/My Drive/Python/results.csv')
res.head()
...
#Write into a file with actual prediction and corresponding probability
pd.concat([pred,pred_Probability],axis=1).to_csv("/gdrive/My Drive/Python/Test_results.csv", index = None)

res=pd.read_csv('/gdrive/My Drive/Python/Test_results.csv')
res.head()
